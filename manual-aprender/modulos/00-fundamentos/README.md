...
> "mapa mental" para que todo lo demás encaje.

Este módulo es la base de TODO. Aunque tengas ganas de saltar directo a HTML, no lo hagas:
aquí están las ideas que harán que los demás módulos se entiendan solos.
...
| # | Capítulo | Qué cubre |
|---|---|---|
| 01 | [¿Qué es programar?](01-que-es-programar.md) | Qué es un lenguaje, código, algoritmo; la mentalidad |
| 02 | [Cómo funciona una computadora](02-como-funciona-la-computadora.md) | Hardware, software, archivos, memoria, el sistema operativo |
| 03 | [Internet y la web](03-internet-y-la-web.md) | Cliente/servidor, IP, DNS, HTTP, qué pasa al abrir una página |
...
No necesitas instalar nada para leer este módulo. Para los ejercicios de los capítulos 04 y
05 usarás la terminal (ya viene en tu computadora) y Git (te diremos cómo instalarlo).

➡️ Empieza por **[Capítulo 01 — ¿Qué es programar?](01-que-es-programar.md)**.
